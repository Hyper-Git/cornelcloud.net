...
const bootLines = [
  '[BOOT] LOADING CORNELCLOUD PORTFOLIO...',
  '[OK]   AWS RE/START GRADUATE',
  '[OK]   TERRAFORM ASSOCIATE AND KCNA CERTIFIED',
  '[OK]   AWS AND KUBERNETES PROJECTS DOCUMENTED',
  '[BOOT] LOADING PORTFOLIO [100%]',
  '[BOOT] READY TO EXPLORE PROJECTS...'
];
